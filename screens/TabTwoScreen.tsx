    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.productsRow}>
          <View style={styles.productsShowcase}>
                ...
                <View style={{alignItems: 'center'}}>
                  <View style={styles.popupHeader}>
                    <TouchableOpacity onPress={() => setVisible(false)}>
                      <Image source={require('./assets/x.png')} style={{width: 15, height: 15}}></Image>
                    </TouchableOpacity>
                  </View>
                </View>
                <View style={{alignItems: 'center'}}>
                  <Image source={require('./assets/tshirtDesign1.jpg')} style={styles.popupProductImage}/>
                </View>
            ...
            <View style={styles.productImageContainer}>
              <Image source={require('./assets/tshirtDesign1.jpg')} style={styles.productImage}/>
            </View>
          ...
          <View style={styles.productsShowcase}>
            <View style={styles.productImageContainer}>
              <Image source={require('./assets/tshirtDesign2.jpg')} style={styles.productImage}/>
            </View>
            <View style={styles.productInfo}>
        ...
        <View style={styles.productsRow}>
          <View style={styles.productsShowcase}>
            <View style={styles.productImageContainer}>
              <Image source={require('./assets/jacketDesign1.jpg')} style={styles.productImage}/>
            </View>
            <View style={styles.productInfo}>
          ...
          <View style={styles.productsShowcase}>
            <View style={styles.productImageContainer}>
              <Image source={require('./assets/jacketDesign2.jpg')} style={styles.productImage}/>
            </View>
            <View style={styles.productInfo}>
              <Text style={styles.productInfoText}>Jacket Design</Text>
        ...
        <View style={styles.productsRow}>
          <View style={styles.productsShowcase}>
            <View style={styles.productImageContainer}>
              <Image source={require('./assets/tarpDesign1.jpg')} style={styles.productImage}/>
            </View>
            <View style={styles.productInfo}>
          ...
          <View style={styles.productsShowcase}>
            <View style={styles.productImageContainer}>
              <Image source={require('./assets/tarpDesign2.jpg')} style={styles.productImage}/>
            </View>
            <View style={styles.productInfo}>
              <Text style={styles.productInfoText}>Tarpaulin Design</Text>
